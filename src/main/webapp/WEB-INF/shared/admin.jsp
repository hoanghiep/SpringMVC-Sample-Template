<%-- 
    Document   : admin.jsp
    Created on : Feb 28, 2015, 10:40:31 AM
    Author     : hieptran
--%>
...
<html>
    <head>
        ...
        <script type="text/javascript" src="<c:url value="/resources/base/js/layout.admin.js?v=1.0.0.1"/>"></script>
        <script type="text/javascript" src="<c:url value="/resources/base/js/current.user.js?v=1.0.0.1"/>"></script>
        <script type="text/javascript" src="<c:url value="/resources/base/js/ajax/request-server.js"/>" type="text/javascript"></script>
    ...
    <body>
        ...
        <div id="app-layout" class="pure-g">
            <div id="nav-panel" class="pure-u">
                <div id="user-profile"></div>
                <div id="user-menu" class="main-menu">
                </div>
                <div id="app-logo" class="pad-top5"></div>
            </div>
            ...
            <script type="text/javascript" src="<c:url value="/resources/base/js/build/components/mixed.react.js"/>"></script>
            ...
            <script type="text/javascript" src="<c:url value="/resources/base/js/build/menu/menu.react.js?v=1.0.0.1"/>"></script>       
